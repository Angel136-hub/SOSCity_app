 ...
 * I nomi italiani precedenti (tecnicoId, statoLavoro, noteIntervento, dataInizio, dataFine, dataCreazione)
 * non corrispondevano a nulla nella risposta reale: i campi sarebbero rimasti
 * sempre vuoti/null. Abbiamo mantenuto i nomi delle property Kotlin in italiano per
 * non rompere il resto del codice che le referenzia, e abbiamo aggiunto @SerializedName
